...
// Monotonic sequence used to order key presses relative to battery updates.
#[cfg(feature = "_ble")]
pub(crate) static KEY_PRESS_SEQUENCE: AtomicU32 = AtomicU32::new(0);
#[cfg(feature = "_ble")]
pub(crate) static KEY_PRESS_SIGNAL: Signal<crate::RawMutex, u32> = Signal::new();
    ...
    Keyboard<'a, ROW, COL, NUM_LAYER, NUM_ENCODER>
{
    ...
    async fn process_key_action_inner(&mut self, original_key_action: &KeyAction, event: KeyboardEvent) {
        ...
        #[cfg(feature = "_ble")]
        if event.pressed {
            let sequence = KEY_PRESS_SEQUENCE
